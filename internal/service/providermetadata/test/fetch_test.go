...
func TestFetchFoldsReverseCompletionInRegistryOrder(t *testing.T) {
	...
	reverseOrder := []string{"openai", "commandcode", "vertex", "claude", "gemini-interactions", "gemini", "xai", "codex"}
	...
	wantAuthIndexes := []string{"codex-auth", "xai-auth", "gemini-auth", "gemini-interactions-auth", "claude-auth", "vertex-auth", "commandcode-auth", "openai-auth"}
...
func TestFetchKeepsOtherSourcesWhenOneProviderFails(t *testing.T) {
	...
	wantTypes := []string{"codex", "xai", "gemini-interactions", "claude", "vertex", "commandcode", "openai"}
...
func TestFetchPreservesCompletedSourcesAndWaitsForCancellation(t *testing.T) {
	...
	waitForSources(t, fetcher.done, []string{"xai", "gemini", "gemini-interactions", "claude", "vertex", "commandcode", "openai"})
	...
	wantError := "fetch xai api keys: context canceled; fetch gemini api keys: context canceled; fetch interactions api keys: context canceled; fetch claude api keys: context canceled; fetch vertex api keys: context canceled; fetch commandcode api keys: context canceled; fetch openai compatibility: context canceled"
