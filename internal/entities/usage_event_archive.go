...
type UsageEventArchive struct {
	...
	InstanceID          string `gorm:"type:text;not null;default:00000000-0000-7000-8000-000000000000"`
	EventKey            string
	APIGroupKey         string
	...
	ParentSessionID     string  `gorm:"column:parent_session_id;not null;default:''"`
