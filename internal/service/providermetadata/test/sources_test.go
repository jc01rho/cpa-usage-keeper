...
func TestFetchNormalizesSevenSourcesInRegistryOrder(t *testing.T) {
	...
	wantTypes := []string{"codex", "xai", "gemini", "gemini-interactions", "claude", "vertex", "commandcode", "openai"}
...
func TestFetchClassifiesOptionalFailuresAndSuccessfulEmptySources(t *testing.T) {
	...
	t.Run("optional typed 404", func(t *testing.T) {
		...
		wantTypes := []string{"codex", "gemini", "claude", "vertex", "commandcode", "openai"}
	...
	t.Run("nil result containing 404 text", func(t *testing.T) {
		...
		if reflect.DeepEqual(snapshot.FetchedProviderTypes, []string{"codex", "xai", "gemini", "gemini-interactions", "claude", "vertex", "commandcode", "openai"}) {
	...
	t.Run("stable warning order", func(t *testing.T) {
		...
		wantTypes := []string{"xai", "gemini-interactions", "vertex", "commandcode", "openai"}
