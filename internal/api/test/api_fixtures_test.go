...
import (
	...
	auth "cpa-usage-keeper/internal/auth"
...
func newUsageViewerRouter(t *testing.T, provider service.UsageProvider) (http.Handler, *http.Cookie) {
	...
	keyProvider := &authCPAAPIKeyStub{row: entities.CPAAPIKey{ID: 42, InstanceID: "0198aa10-4d88-7a20-8f4e-8c8de4a9cb11", APIKey: "sk-cpa-viewer", DisplayKey: "sk-...viewer"}}
